...
print(10 + 3)
print(10 - 3)
print(10 / 3) #It will get a float number
print(10 // 3)#It will get an int
print(10 % 3)#It will get the remainder of the division
...
price = 5
print(price > 10) # it true because the not operator
